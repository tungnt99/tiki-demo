...
$(document).ready(function() {
    $(".slider__s1").slick({
        ...
        autoplay: true,
        autoplaySpeed: 2000,
        prevArrow: "<button type='button' class='slick-prev pull-left'><i class='fa fa-angle-left slick__pre-icon' aria-hidden='true'></i></button>",
        nextArrow: "<button type='button' class='slick-next pull-right'><i class='fa fa-angle-right slick__next-icon' aria-hidden='true'></i></button>",
        responsive: [{
                breakpoint: 740,
                settings: {
                    slidesToShow: 1,
...
$(document).ready(function() {
    $(".slider__active").slick({
        ...
        slidesToShow: 6,
        slidesToScroll: 6,
        prevArrow: "<button type='button' class='slick-prev pull-left' id='slick__prevActive'><i class='fa fa-angle-left slick__pre-icon' aria-hidden='true'></i></button>",
        nextArrow: "<button type='button' class='slick-next pull-right' id='slick__nextActive'><i class='fa fa-angle-right slick__next-icon' aria-hidden='true'></i></button>",
        responsive: [{
                breakpoint: 740,
                settings: {
                    slidesToShow: 4,
